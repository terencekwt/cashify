var collie=collie||{};(function(){collie.version="1.0.7";collie.Class=function(f,e){var c=null;if("$init" in f){c=f.$init;
...
this._elImage=null}if(e.backgroundImage&&a){if(!d&&e.backgroundImage){var b;if(this._elImage===null){this._elImage=a.cloneNode();
b=this._elImage.style;b.position="absolute";b.top=0;b.left=0;b.width=f.width+"px";b.height=f.height+"px";if(this._bSupportCSS3d&&this._bUseTranslateZ){b[this._sTransform]="translateZ(0)"
}this._el.appendChild(this._elImage)}else{this._elImage.src=a.src;b=this._elImage.style;b.width=f.width+"px";b.height=f.height+"px"
